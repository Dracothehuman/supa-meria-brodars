...
function start(){
  GameStatus="start";
  document.getElementById("status").innerHTML="Start da game.";
}
...
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Click da play button to start da super mario brothers for nintendo 3ds ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
